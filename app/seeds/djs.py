...
def seed_djs():
    ...
    calvin_harris = DJ(stagename='Calvin Harris', firstname='Adam', lastname='Wiles', debut_year=2002, genre_id=9, group=False, nationality='British')
    ...
    david_guetta = DJ(stagename='David Guetta', firstname='David', lastname='Guetta', debut_year=2002, genre_id=9, group=False, nationality='French')
    ...
    dillon_francis = DJ(stagename='Dillon Francis', firstname='Dillon', lastname='Francis', debut_year=2010, genre_id=18, group=False, nationality='American')
    ...
    knock2 = DJ(stagename='Knock2', firstname='Richard', lastname='Nakhonethap', debut_year=2019, genre_id=7, group=False, nationality='American')
    iso_xo = DJ(stagename='Isoxo', firstname='Julian', lastname='Isorena', debut_year=2018, genre_id=7, group=False, nationality='American')
    ...
    galantis = DJ(stagename='Galantis', firstname='Christian, Linus', lastname='Eklöw, Åkesson', debut_year=2012, genre_id=9, group=True, nationality='Swedish')
    slander = DJ(stagename='Slander', firstname='Derek, Scott', lastname='Andersen, Land', debut_year=2010, genre_id=7, group=True, nationality='American')
    yellow_claw = DJ(stagename='Yellow Claw', firstname='Jim, Nils', lastname='Aasgård, Visser', debut_year=2010, genre_id=7, group=True, nationality='Dutch')
    flosstradamus = DJ(stagename='Flosstradamus', firstname='Curt, Josh', lastname='Camerson, Young', debut_year=2006, genre_id=7, group=True, nationality='American')
