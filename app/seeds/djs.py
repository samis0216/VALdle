...
def seed_djs():
    ...
    knock2 = DJ(stagename='Knock2', firstname='Richard', lastname='Nakhonethap', debut_year=2019, genre_id=7, group=False, nationality='Laos')
    iso_xo = DJ(stagename='Isoxo', firstname='Julian', lastname='Isorena', debut_year=2018, genre_id=7, group=False, nationality='Phillipines')
